                            ...
                            <div class="card-body">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $querysewa = mysqli_query($koneksi, "SELECT * FROM data_sewa");
                                        while ($data = mysqli_fetch_array($querysewa)) {
                                            ?>
                                            <tr>
                                                <th scope="row">
                                                    <?= $no++ ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Data Sewa</h1>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="fungsieditsewa.php">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="text" class="form-control" name="tsewa" value="<?= $data['sewa'] ?>">
                                                                        </div>
                                                                        <div class="modal-body">
