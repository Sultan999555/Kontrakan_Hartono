...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Data Rekam Iuran</h1>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"><center>no_kontrakan</center></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="fungsieditrekamiuran.php?id=<?= $data['id_penghuni'] ?>" class="btn btn-sm btn-warning"><i class="fa-solid fa-pencil" title="Update Supplie"></i></a>
