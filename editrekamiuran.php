                    ...
                    <div class="card master">
                        <div class="card">
                            <div class="card-header">
                                <span class="h5 my-2">Rekam Iuran</span>
                                <a href="<?= $main_url ?>inputiuran.php" class="btn btn-sm btn-primary float-end">Tambah Iuran</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $queryiuran = mysqli_query($koneksi, "SELECT * FROM rekam_iuran");
                                        while ($data = mysqli_fetch_array($queryiuran)) {
                                            ?>
                                            <tr>
                                                <th scope="row">
                                                    <?= $no++ ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Rekam Iuran</h1>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form method="POST" action="fungsieditrekamiuran.php">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="text" class="form-control" name="tiuran" value="<?= $data['iuran'] ?>">
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <label class="form-label">Tanggal Bayar</label>
                                                                            <input type="text" class="form-control" name="ttanggalbayar" value="<?= $data['tanggal_bayar'] ?>">
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <label class="form-label">Keterangan</label>
                                                                            <input type="text" class="form-control" name="tketerangan" value="<?= $data['keterangan'] ?>">
                                                                        </div>
